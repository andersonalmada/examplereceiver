...
// MetricsConfig provides config for examplereceiver/filesystem metrics.
...
// MetricsBuilderConfig is a configuration for examplereceiver/filesystem metrics builder.
